...
Tổng sản phẩm quốc dân lớn hơn tổng sản phẩm quốc nội
Tất cả đều sai
Giả sử cho hàm cầu tiền là MD = 200-100i +20Y, hàm MS = 400. Vậy phương trình đường LM:
i = 6 + 0,2Y
i = -2 + 0,2Y
i = -2 - 0,2Y
i = 2 + 0,2Y
...
Tất cả đều sai
Nếu ngân hàng trung ương lµm cho lượng cung tiền gia tăng:
Đường IS dịch chuyển sang phải.
Đường IS dịch chuyển sang trái.
Đường LM dịch chuyển sang trái.
Chỉ có sự di chuyển dọc trên đường LM.
Đường LM dịch chuyển sang phải.
Chính sách gia tăng thuế của chính phủ sẽ:
Dẫn đến đường IS dịch chuyển sang trái và đường LM dịch chuyển sang trái
Dẫn đến đường IS dịch chuyển sang phải.
Dẫn đến đường IS dịch chuyển sang trái.
Không ảnh hưởng đến đường IS.
Có sự di chuyển dọc đường IS.
Yếu tố nào sau đây không phải là tính chất của GNP thực:
Tính theo giá cố định
Chỉ đo lường sản phẩm cuối cùng
Tính theo giá hiện hành
...
Tất cả đều sai
Tất cả đều đúng
Trong mô hình IS-LM, chính sách  tài chính mở rộng dẫn đến
Đường IS dịch chuyển sang phải.
Lãi suất tăng, đầu tư giảm.
Sản lượng tăng và lãi suất giảm.
Đường IS dịch chuyển sang trái và lãi suất giamr, đầu tư tăng.
Đường IS dịch chuyển sang phải và lãi suất tăng, đầu tư giảm.
Câu nào dưới đây không đúng ?
Đường IS có độ dốc càng nhỏ thì chính sách tài khóa càng tác động mạnh đến sản lượng.
Đường LM có độ dốc càng nhỏ thì chính sách tài khóa càng tác động mạnh đến sản lượng.
Đường IS có độ dốc càng lớn thì chính sách tài khóa càng tác động mạnh đến sản lượng.
Đường LM có độ dốc càng nhỏ thì chính sách tiền tệ càng tác động mạnh đến sản lượng.
Đường IS có độ dốc càng nhỏ thì chính sách tiền tệ càng tác động mạnh đến sản lượng.
...
Nếu đường IS có dạng thẳng đứng thì
Chính sách tiền tệ không tác động đến sản lượng.
Chính sách tiền tệ tác động mạnh đến sản lượng.
Chính sách tiền tệ không tác động đến sản lượng và chính sách tài chính tác động mạnh đến sản lượng.
Chính sách tài chính tác động mạnh đến sản lượng.
Tất cả đều sai
...
| Tiêu dùng C = 200 + 0,75(Y – T) Đầu tư: I = 225 – 25i Chi tiêu của chính phủ: G = 75 Thuế ròng: T = 100 | Cung tiền thực tế MS = 600 Cầu tiền thực tế MD = Y – 100i || --- | --- |
...
Y = 1700 + 100i và Y = 600 + 100i
Không có câu nào đúng
Trong mô hình IS -LM, khi sản lượng thấp hơn mức tiềm năng, chính phủ nên áp dụng
Chính sách tài chính mở rộng.
Chính sách tiền tệ mở rộng.
Chính sách tài chính mở rộng hoặc chính sách tiền tệ mở rộng hoặc kết hợp cả chính sách tài chính mở rộng và chính sách tiền tệ mở rộng.
Kết hợp chính sách tài chính mở rộng và chính sách tiền tệ mở rộng.
Tất cả đều sai
...
Thị trường hàng hóa và tiền tệ của một nền kinh tế đóng được mô tả như sau:
| Tiêu dùng C = 200 + 0,75(Y – T) Đầu tư: I = 225 – 25i Chi tiêu của chính phủ: G = 75 Thuế ròng: T = 100 | Cung tiền danh nghĩa MS = 1000 Cầu tiền thực tế MD = Y – 100i Mức giá P = 2 || --- | --- |
...
Thị trường hàng hóa và tiền tệ của một nền kinh tế đóng được mô tả như sau:
| Tiêu dùng C = 200 + 0,75(Y – T) Đầu tư: I = 225 – 25i Chi tiêu của chính phủ: G = 75 Thuế ròng: T = 100 | Cung tiền danh nghĩa MS = 1000 Cầu tiền thực tế MD = Y – 100i Mức giá P = 4 || --- | --- |
Mức thu nhập và lãi suất cân bằng là:
Y = 97,5 và i = 6%
Y = 97,5 và i = 7%
Y = 97,5 và i = 8%
...
Không có câu nào đúng.
II. Một số bài tập
Bài 1. Có tài liệu về lượng cung, cầu theo giá của hàng X như sau:
| Giá (Ngđ/SP) | 20 | 22 | 24 | 26 | 28 | 30 | 32 | 34 | 36 || --- | --- | --- | --- | --- | --- | --- | --- | --- | --- || Lượng cung (SP/ Ngày) | 80 | 100 | 120 | 140 | 160 | 180 | 200 | 220 | 240 || Lượng cầu (SP/ Ngày) | 280 | 250 | 220 | 190 | 160 | 130 | 100 | 70 | 40 |
Yêu cầu:
Tìm phương trình cung, cầu của mặt hàng X. Xác định sản lượng và giá cân bằng trên thị trường của hàng X.
Tính thặng dư tiêu dùng và thặng dư sản xuất. Vẽ đồ thị minh họa.
Tính hệ số co dãn của cầu theo giá tại điểm cân bằng và trong khoảng giá 34 – 36. Cho biết ý nghĩa?
Nếu Chính phủ đánh thuế ở mức cố định 4 Ngđ/SP bán ra thì giá, sản lượng cân bằng sẽ thay đổi như thế nào? Vẽ đồ thị minh hoạ.
Nếu Chính phủ quy định giá sàn của hàng X là 30 Ngđ/SP thì tình trạng của thị trường hàng X như thế nào? Giá và sản lượng trao đổi thực tế trên thị trường bằng bao nhiêu? Minh hoạ tình trạng này trên đồ thị
Nếu Chính phủ quy định giá trần của hàng X là 24 Ngđ/SP thì tình trạng của thị trường hàng X như thế nào? Giá và sản lượng trao đổi thực tế trên thị trường bằng bao nhiêu? Minh hoạ tình trạng này trên đồ thị.
Nếu Chính phủ trợ cấp 1Ngđ/sp bán ra thì thì giá, sản lượng cân bằng sẽ thay đổi như thế nào? Vẽ đồ thị minh hoạ.
Nếu cầu về sản phẩm tăng thêm 5sp tại mỗi mức giá thì giá và sản lượng cân bằng thay đổi như thế nào? Vẽ đồ thị minh hoạ.
Bài 2. Một người tiêu dùng có hàm lợi ích đối với 2 mặt hàng X và Y là TU = 25.X.(Y + 4); Giá mặt hàng X là 10 Ngđ/kg và giá mặt hàng Y là 8 Ngđ/kg.
Yêu cầu:
Vẽ các đường bàng quan TU = 15.000. Tính tỷ lệ thay thế cận biên giữa hai hàng hóa X và Y. Cho biết ý nghĩa giá trị tìm được.
Vẽ đường ngân sách 400 Ngđ.
Để tối đa hoá lợi ích thì người này sẽ mua và tiêu dùng bao nhiêu hàng X và bao nhiêu hàng Y khi ngân sách tiêu dùng hai mặt hàng này là 448 Ngđ; Tính lợi ích tối đa đạt được, thể hiện kết quả trên đồ thị.
Nếu giá mặt hàng Y tăng 25% thì người này sẽ tiêu dùng như thế nào để đạt được lợi ích tối đa, tính lợi ích tối đa đạt được. Tìm hàm cầu của người này đối với hai mặt hàng Y khi Px,I cố định, biểu diễn đường cầu  trên đồ thị.
Bài 3. Một doanh nghiệp có hàm sản xuất: 	Q = 5.L.(K - 4)
Chi phí cho một đơn vị lao động là w = 20 và cho một đơn vị vốn là r = 30.
Yêu cầu:
Vẽ đường đẳng phí TC = 450 và xác định độ dốc của chúng, Cho nhận xét;
Vẽ đường đẳng lượng Q = 100; Tính tỷ lệ thay thế kỹ thuật biên giữa K và L.
Tính chi phí thấp nhất khi doanh nghiệp muốn sản lượng sản xuất là Q = 100 sản phẩm. Thể hiện kết quả trên đồ thị.
Với chi phí 450 thì sản lượng tối đa đạt được là bao nhiêu? Minh hoạ bằng đồ thị.
Bài 4: Cầu thị trường về 1 loại sản phẩm là: P = 500 – Q. Một doanh nghiệp cung cấp với hàm chi phí: TC = Q2 + 20Q + 5000 (TC: Trđ; Q: NgSP, p: Ngđ/SP).
Yêu cầu:
1. Xác định chi phí cố định, chi phí biến đổi, chi phí bình quân, chi phí biến đổi bình quân của doanh nghiệp.
2. Hãy xác định giá và sản lượng tối đa hoá lợi nhuận cho doanh nghiệp. Tính lợi nhuận tối đa đạt được.
3. Hãy xác định giá và sản lượng tối đa hoá doanh thu cho doanh nghiệp. Tính lợi nhuận đạt được.
3. Nếu doanh nghiệp này muốn đạt mục tiêu doanh thu càng lớn càng tốt ở mức lợi nhuận là 10.000 Trđ thì doanh nghiệp sẽ lựa chọn sản lượng và giá bán là bao nhiêu?
Bài 5. Một nền kinh tế đóng có tiêu dùng tối thiểu là 1.000, xu hướng tiêu dùng biên là 0,7; Đầu tư của các doanh nghiệp cố định ở mức 2.000. Chi tiêu của Chính phủ dự kiến là 2.000 và được tài trợ bởi thuế T = 0,1Y.
Yêu cầu:
Xác định hàm tổng cầu và sản lượng cân bằng của nền kinh tế. Vẽ đồ thị minh họa.
Tính tiêu dùng, tiết kiệm của nền kinh tế tại mức sản lượng cân bằng? Xác định trạng thái của ngân sách nhà nước.
Nếu xu hướng tiêu dùng biên tăng 10% thì tổng cầu, sản lượng cân bằng, tiêu dùng, tiết kiệm của nền kinh tế thay đổi như thế nào?
Nếu thuế suất giảm đi 20% thì tổng cầu, sản lượng cân bằng, tiêu dùng, tiết kiệm của nền kinh tế thay đổi như thế nào?
Nếu chi tiêu của Chính phủ là 2.000 và được tài trợ toàn bộ bởi thuế không phụ thuộc vào thu nhập, tính sự thay đổi của tổng cầu, sản lượng cân bằng, tiêu dùng và tiết kiệm của nền kinh tế./.
Bài 6: Một nền kinh tế mở có tiêu dùng tối thiểu là 1.000, xu hướng tiêu dùng biên là 0,7; Đầu tư của các doanh nghiệp cố định ở mức 2.000. Chi tiêu của Chính phủ dự kiến là 3.000 và được tài trợ toàn bộ bởi thuế T = 0,1Y; xu hướng nhập khẩu biên là 0,2 và xuất khẩu dự kiến 2.000
Yêu cầu:
Xác định hàm tổng cầu; sản lượng cân bằng và số nhân chi tiêu của nền kinh tế. Vẽ đồ thị minh họa.
Nếu xu hướng tiêu dùng biên giảm 10% thì tiêu dùng, tiết kiệm của nền kinh tế thay đổi như thế nào?
Nếu xu hướng nhập khẩu biên tăng 20%, tính tiêu dùng, tiết kiệm của nền kinh tế?./.
Nếu chi tiêu của Chính phủ là 2.000 và được tài trợ toàn bộ bởi thuế không phụ thuộc vào thu nhập, tính sự thay đổi của tổng cầu, sản lượng cân bằng, tiêu dùng và tiết kiệm của nền kinh tế./.
Bài 7. Giả sử một nền kinh tế được biểu diễn bởi những thông số sau
| C = 250 + 0,6Yd. I = 200 – 10i + 0,2Y G = 400 | T = 0,1Y MD = 40 + 0,1Y – 10i Mức cung tiền danh nghĩa bằng 600 Mức giá chung P = 4 || --- | --- |
Yêu cầu:
Viết phương trình đường IS và LM, Xác định mức thu nhập và mức lãi suất cân bằng của nền kinh tế? Vẽ đồ thị.
Nếu chi tiêu của Chính phủ giảm đi 50, mức lãi suất và mức thu nhập cân bằng mới của nền kinh tế bằng bao nhiêu? Nhận xét về chính sách tài khoá và sử dụng đồ thị minh hoạ.
Giả sử G không đổi nhưng Ngân hàng trung ương tăng cung ứng tiền tệ thực tế thêm 100. Xác định mức lãi suất và thu nhập cân bằng mới? Nhận xét về chính sách tiền tệ và sử dụng đồ thị minh hoạ.
Bài 8. Một nền kinh tế được biểu diễn bởi những thông số sau
C = 200 + 0,8Yd.
I = 200 – 10i + 0,1Y
G = 400
T = 50 + 0,1Y
...
MS = 400
Yêu cầu:
Viết phương trình đường IS và LM? Xác định mức thu nhập và mức lãi suất cân bằng của nền kinh tế? Vẽ đồ thị minh họa?
Nếu chi tiêu của Chính phủ tăng thêm 40, mức lãi suất và mức thu nhập cân bằng mới của nền kinh tế bằng bao nhiêu? Nhận xét về chính sách tài khoá và sử dụng đồ thị minh hoạ.
Để giữ lãi suất không đổi, ngân hàng trung ương cần thay đổi chính sách tiền tệ như thế nào?
Giả sử G không đổi nhưng Ngân hàng trung ương tăng cung ứng tiền tệ thêm 100. Xác định mức lãi suất và thu nhập cân bằng mới? Nhận xét về chính sách tiền tệ và sử dụng đồ thị minh hoạ.
