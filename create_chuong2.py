# Script tạo chuong_2.json từ chuong_2.txt và chuong_2_answers.json

import json
import re

# Load answers from scan
with open('chuong_2_answers.json', 'r', encoding='utf-8') as f:
...
# Parse chuong_2.txt
with open('chuong_2.txt', 'r', encoding='utf-8') as f:
    content = f.read()
...
# Save
with open('chuong_2.json', 'w', encoding='utf-8') as f:
    json.dump(output, f, ensure_ascii=False, indent=2)

print(f'✓ Created chuong_2.json with {len(questions)} questions')
